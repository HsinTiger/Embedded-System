...
int main(int argc, const char *argv[])
{
    for (int i=0;i<600;i++) {
	    ...
	    if(i%3 == 0)
		image = cv::imread("./1.jpg", cv::IMREAD_UNCHANGED);
	    else if(i%3 == 1)
		image = cv::imread("./2.jpg", cv::IMREAD_UNCHANGED);
	    else if(i%3 == 2)
		image = cv::imread("./3.jpg", cv::IMREAD_UNCHANGED);
		...
		// https://docs.opencv.org/3.4.7/d3/d63/classcv_1_1Mat.html#a13acd320291229615ef15f96ff1ff738
			...
			ofs.write((char*)(image.cv::Mat::ptr(y)), fb_info.xres_virtual * fb_info.bits_per_pixel / 8);
	    }
	sleep(3);
	}
	    return 0;
